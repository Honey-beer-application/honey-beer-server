...
namespace honey_beer_server_app.Migrations
{
    ...
    [Migration("20230802203317_ChangingCompositeKeyInScannedByCustomerTable")]
    partial class ChangingCompositeKeyInScannedByCustomerTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("honey_beer_server_app.Models.ScannedByCustomer", b =>
                {
                    ...
                    b.HasIndex("QRCodeId", "CustomerId")
                        .IsUnique();
